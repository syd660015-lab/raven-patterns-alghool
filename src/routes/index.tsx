      ...
      <Dialog open={guideOpen} onOpenChange={setGuideOpen}>
        <DialogContent className="max-w-lg" dir="rtl">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="space-y-2">
              <Label>حالات شائعة (اضغط لإدراج السبب ثم عدّله)</Label>
              <div className="flex flex-wrap gap-2">
                {[
                  { label: "تأخر لغوي", text: "تأخر لغوي يحدّ من فهم التعليمات اللفظية، تم اختيار CPM لاعتماده على المثيرات البصرية." },
                  { label: "إعاقة ذهنية بسيطة", text: "إعاقة ذهنية بسيطة موثقة سابقاً، الجلسة لأغراض استرشادية لرصد مستوى الأداء الحالي." },
                  { label: "اضطراب طيف التوحد", text: "المفحوص ضمن طيف التوحد ويصعب تطبيق اختبارات لفظية، تم استخدام CPM كبديل بصري." },
                  { label: "صعوبات تعلم", text: "صعوبات تعلم نوعية تؤثر على القراءة، اختيار CPM لتفادي العبء اللغوي." },
                  { label: "ضعف سمعي", text: "ضعف سمعي يمنع تطبيق الاختبارات اللفظية القياسية، CPM مناسب لاعتماده على البصر." },
                  { label: "لا يتوفر اختبار بديل", text: "لا تتوفر أداة بديلة معيّرة (SPM/APM/WPPSI) في المؤسسة حالياً، تم الاكتفاء بـ CPM استرشادياً." },
                  { label: "لأغراض المسح المبدئي", text: "الجلسة ضمن مسح مبدئي سريع، النتائج استرشادية وتحتاج تأكيداً بأداة معيّرة لاحقاً." },
                  { label: "بناءً على طلب الأسرة", text: "تم تطبيق الاختبار بناءً على طلب الأسرة رغم خروج العمر عن النطاق، مع إبلاغهم بمحدودية التفسير." },
                ].map((c) => (
                  <Button
                    key={c.label}
                    type="button"
                    ...
                    onClick={() =>
                      setOorReason((prev) => (prev.trim() ? prev.trim() + "\n" + c.text : c.text))
                    }
                  >
                    + {c.label}
                  </Button>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                rows={4}
                placeholder="اختر من الحالات الشائعة أعلاه أو اكتب السبب يدوياً..."
              />
            </div>
          </div>
